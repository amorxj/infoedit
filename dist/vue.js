...
(function(global, factory) {
...

  {
    ...
    formatComponentName = function(vm, includeFile) {
      ...
      var name = vm._isVue ? vm.$options.name || vm.$options._componentTag :
        vm.name;
  ...
  function mergeOptions(
    ...
    if (extendsFrom) {
      parent = typeof extendsFrom === 'function' ? mergeOptions(parent,
        extendsFrom.options, vm) : mergeOptions(parent, extendsFrom, vm);
    }
    if (child.mixins) {
  ...
  function defineComputed(target, key, userDef) {
    if (typeof userDef === 'function') {
      ...
      sharedPropertyDefinition.get = userDef.get ? userDef.cache !==
        false ? createComputedGetter(key) : userDef.get : noop;
        ...
        for (var key in value) {
          if (key === 'class' || key === 'style') {
            ...
            var hash = asProp || config.mustUseProp(tag, type, key) ?
              data.domProps || (data.domProps = {}) : data.attrs || (data
                .attrs = {});
            hash[key] = value[key];
          }
        }
      ...
      try {
        ...
        /* istanbul ignore else */
        {
          vnode = vm.$options.renderError ? vm.$options.renderError.call(
            vm._renderProxy, vm.$createElement, e) : vm._vnode;
        }
      }
  ...
  var Transition = {
    ...
    render: function render(h) {
      ...
      child.key = child.key == null ? id + child.tag : isPrimitive(
        child.key) ? (String(child.key).indexOf(id) === 0 ? child.key :
        id + child.key) : child.key;
  ...
  function parse(
    ...
    parseHTML(template, {
      ...
      chars: function chars(text) {
        if (!currentParent) {
          if ("development" !== 'production' && !warned && text ===
            template) {
            warned = true;
            warn$2(
    ...
    if (!options.render) {
      ...
      if (template) {
        ...
        if ("development" !== 'production' && config.performance &&
          ...
          perf.measure(((this._name) + " compile"), 'compile',
            'compile end');
        }
      }
    }
